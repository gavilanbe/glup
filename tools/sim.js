...
const FILES = ['art.js', 'mundo.js', 'audio.js', 'levels.js', 'cine.js', 'titulo.js', 'mapa.js', 'hud.js', 'aprende.js', 'fx.js', 'garza.js', 'game.js'].filter(f => fs.existsSync(path.join(ROOT, f)));
