...
const FILES = ['art.js', 'mundo.js', 'audio.js', 'levels.js', ...NIVELES, 'cine.js', 'titulo.js', 'mapa.js', 'hud.js', 'aprende.js', 'letra.js', 'maestros.js', 'fx.js', 'barca.js', 'victoria.js', 'garza.js', 'final.js', 'game.js'].filter(f => fs.existsSync(path.join(ROOT, f)));
