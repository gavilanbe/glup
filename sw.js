...
const CACHE = 'glup-15';
const SHELL = ['./', './index.html', './manifest.webmanifest', './style.css', './art.js', './mundo.js', './audio.js', './levels.js', './cine.js', './titulo.js', './mapa.js', './hud.js', './aprende.js', './victoria.js', './game.js',
