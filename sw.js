...
const CACHE = 'glup-31';
const SHELL = ['./', './index.html', './manifest.webmanifest', './style.css', './art.js', './mundo.js', './audio.js', './musica/marsh.js', './musica/dock.js', './musica/cave.js', './musica/storm.js', './musica/omen.js', './musica/sad.js', './musica/march.js', './musica/victoria.js', './musica/alba.js', './musica/creditos.js', './musica/heron.js', './musica/heron2.js', './musica/heron3.js', './musica/juncos.js', './musica/raices.js', './musica/molino.js', './musica/muelle.js', './levels.js',
  ...
  './cine.js', './titulo.js', './mapa.js', './hud.js', './aprende.js', './letra.js', './maestros.js', './barca.js', './victoria.js', './garza.js', './final.js', './gramola.js', './game.js',
